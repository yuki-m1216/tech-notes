...
アラートは「受け取った人が具体的なアクションを起こせる」ものに限定することを推奨します。

**設計時の確認項目:**

- このアラートを受けたとき、具体的に何をするか？
- そのアクションを起こせる人に通知されているか？
- アクションが不要なら、そもそも通知が必要か？

**アクション可能なアラートの例:**

| アラート | アクション |
|---------|-----------|
| API Gatewayの5xxエラー率上昇 | ログ調査、デプロイのロールバック検討 |
| RDS接続数が80%超過 | コネクションプール設定の見直し、スケールアップ検討 |
| Lambda スロットリング発生 | 同時実行数の制限緩和申請、アーキテクチャ見直し |

**アクション不能なアラートへの対処:**

| 状況 | 対処 |
|-----|------|
| 情報共有のみが目的 | Infoレベルに下げ、ダッシュボードで定期確認 |
| AWS側の復旧を待つしかない | Warningに下げ、週次レビューで傾向を確認 |
| 誰も対応方法を知らない | ランブックを整備するか、アラート自体を見直す |

**アクション不能なアラートが引き起こす問題:**

- **アラート疲れ**: 対応できないアラートが積み重なり、重要なアラートを見逃す
- **責任の曖昧化**: 「誰かが見ているだろう」と全員がスルーする
- **信頼性の低下**: アラートシステム自体が信用されなくなる
